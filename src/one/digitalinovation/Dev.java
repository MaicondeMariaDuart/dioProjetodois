...
public class Dev {
	...
	public void inscrever(Conteudo conteudo) {
		if (conteudosInscritos.contains(conteudo)) {
			 System.err.println("Voce ja se inscreveu neste conteudo");
		} else{
	...
	public void inscrever(Bootcamp bootcamp) {
		...
		// API de Stream que também pode ser usado fora o FOR
	...
	public void progredir() {
		Optional<Conteudo> conteudo = conteudosInscritos.stream().findFirst();
			...
			conteudosInscritos.remove(conteudo.get());
				...
				System.err.println("Você não está mais inscrito em nemhum contéudo.");
			}
